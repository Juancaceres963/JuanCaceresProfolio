...
export const projects = [
  ...
  role:
    "Initially joined as a coach, I later identified organizational gaps and took the initiative to develop a digital system that allowed the team to manage finances, evaluate performance, and visualize their evolution. I designed and implemented all tools myself using Google Sheets and AppSheet.",
  tools: [
    "Google Sheets",
    "AppSheet",
    "Google Drive",
